...
const Login: React.FC = () => {
  ...
  return (
      ...
      <div className="p-8 rounded-lg shadow-md w-[30vw] items-center ml-[23vw]">
        <h1 className="text-2xl font-semibold mb-4 text-zinc-700 text-center">Login</h1>
        <form>
            <div className="mb-4">
            ...
            <button type="submit" className="h-14 w-full bg-pink-logo text-white py-2 px-4 rounded-md hover:bg-pink-900 focus:outline-none focus:bg-pink-800 text-lg" onClick={handleSubmit}>Login</button>
        </form>
        <p className="text-gray-600 text-sm mt-4">Ainda não possui uma conta? <a href="/Cadastro" className="text-pink-logo  hover:underline">Cadastre-se</a></p>
        </div>
    </div>
  );
}
